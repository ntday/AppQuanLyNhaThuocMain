...
{
    public partial class frm_childSuaNT : Form
    {
        NhomThuoc nt = new NhomThuoc();
        public frm_childSuaNT()
        {
            InitializeComponent();
        }
        ...
        private void frm_childSuaNT_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    nt.suaNhomThuoc(ten, mota,ma);
                    MessageBox.Show("thay đổi thành công nhóm thuốc " + ten, "THÔNG BÁO ");
